...
let two = new Vehicle()
let three = new Car()
console.log(Vehicle.isVehicle(one)) //false - cause Newcar does not extend Vehicle, hence one not an instance of Vehicle
console.log(Vehicle.isVehicle(two)) //true - cause direct instance of vehicle
console.log(Vehicle.isVehicle(two)) //true - cause Car extends Vehicle, three instance of Car, hence instance of Vehicle
