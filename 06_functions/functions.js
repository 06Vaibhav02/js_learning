...
let value = processTeaOrder(makeTea);    //after return from processTeaOrder() - `tea is earl graylet `
// console.log(value);
...
//analog - influencer(my fans have come) | electrician(my fans have come)  
